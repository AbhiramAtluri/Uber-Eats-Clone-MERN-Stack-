...
exports.DeliveryAddressAdd =async function (msg,callback)
{
  let req = {body:{...msg}}
...
var newAddress = new DeliveryModel(
   ...
   newAddress.save((err,resp)=>
   {
    ...
    callback(null,{ message: "success",del_id:resp._id})
    console.log(resp)   
   }
   )
...
exports.FetchDelAddress =async function (msg,callback)
{
    let req = {body:{...msg}}
...
exports.fetchingCustNumber= async function(msg,callback)
{
    ...
    Customer_Registration_Model.findOne({_id:req.body.c_id},(err,resp)=>
    {
        if(resp)
        {
            ...
            //     c_name:resp.c_name
            // })
           callback(null,{c_number:resp.c_number,
        c_email:resp.c_email,
        c_name:resp.c_name })
...
exports.placingOrder =async function(msg,callback)
{
...
exports.fetchOrders = async function(msg,callback)
{
    let req = {body:{...msg}}
        OrderModel.find({c_id:req.body.c_id},(err,resp)=>
        {
          ...
          {
            callback(null,{message:"Noorders"})  
          }
        }
        )
}
...
exports.FetchDelAddressInCustomerOrders =async function (msg,callback)
{
